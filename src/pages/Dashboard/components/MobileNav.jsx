...
const MobileNav = () => {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t-0 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-50 flex justify-around items-center h-16">
      <a className="flex flex-col items-center justify-center gap-1 text-red-700 font-bold" href="#dashboard">
        <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>dashboard</span>
        <span className="text-[9px] uppercase font-label">HUD</span>
      </a>
      <a className="flex flex-col items-center justify-center gap-1 text-stone-400" href="#incidents">
      ...
      <a className="flex flex-col items-center justify-center gap-1 text-stone-400" href="#profile">
